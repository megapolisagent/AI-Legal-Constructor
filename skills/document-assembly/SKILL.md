...
Работает как Skill внутри Foundation-агента (диалог, не отдельное веб-приложение) —
структура данных и правила комплекта не зависят от того, как собраны входные данные.
...
Состав комплекта читается из `document_rules.json` — это данные, не код, агент правит
сам. Три шага:
